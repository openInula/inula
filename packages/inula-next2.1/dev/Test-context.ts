import { delegateEvent, compBuilder, createHTMLNode, setHTMLProp, createFragmentNode, createCompNode, createContextNode, createContext, useContext } from '../src';
    ...
    createFragmentNode(
      ...
      createHTMLNode('div', () => {}, 
        createContextNode(
          ...
          createCompNode(UserProfile(), node => {})
        ),
      )
    )
  )
