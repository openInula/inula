...
if (Test-Path "$basedir/node$exe") {
  ...
  if ($MyInvocation.ExpectingInput) {
    $input | & "$basedir/node$exe"  "$basedir/../../../../../webpack-cli@5.1.4_55ctblq7vmnkc7msvxpxtdxasq/node_modules/webpack-cli/bin/cli.js" $args
  } else {
    & "$basedir/node$exe"  "$basedir/../../../../../webpack-cli@5.1.4_55ctblq7vmnkc7msvxpxtdxasq/node_modules/webpack-cli/bin/cli.js" $args
  }
  $ret=$LASTEXITCODE
} else {
  # Support pipeline input
  if ($MyInvocation.ExpectingInput) {
    $input | & "node$exe"  "$basedir/../../../../../webpack-cli@5.1.4_55ctblq7vmnkc7msvxpxtdxasq/node_modules/webpack-cli/bin/cli.js" $args
  } else {
    & "node$exe"  "$basedir/../../../../../webpack-cli@5.1.4_55ctblq7vmnkc7msvxpxtdxasq/node_modules/webpack-cli/bin/cli.js" $args
  }
  $ret=$LASTEXITCODE
}
