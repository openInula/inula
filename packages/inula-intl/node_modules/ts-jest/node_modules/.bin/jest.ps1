...
if (Test-Path "$basedir/node$exe") {
  ...
  if ($MyInvocation.ExpectingInput) {
    $input | & "$basedir/node$exe"  "$basedir/../../../../../jest@29.3.1_546szy65dvhukjyz7aaas7covq/node_modules/jest/bin/jest.js" $args
  } else {
    & "$basedir/node$exe"  "$basedir/../../../../../jest@29.3.1_546szy65dvhukjyz7aaas7covq/node_modules/jest/bin/jest.js" $args
  }
  $ret=$LASTEXITCODE
} else {
  # Support pipeline input
  if ($MyInvocation.ExpectingInput) {
    $input | & "node$exe"  "$basedir/../../../../../jest@29.3.1_546szy65dvhukjyz7aaas7covq/node_modules/jest/bin/jest.js" $args
  } else {
    & "node$exe"  "$basedir/../../../../../jest@29.3.1_546szy65dvhukjyz7aaas7covq/node_modules/jest/bin/jest.js" $args
  }
  $ret=$LASTEXITCODE
}
