...
if (Test-Path "$basedir/node$exe") {
  ...
  if ($MyInvocation.ExpectingInput) {
    $input | & "$basedir/node$exe"  "$basedir/../../../../../typescript@4.9.3/node_modules/typescript/bin/tsc" $args
  } else {
    & "$basedir/node$exe"  "$basedir/../../../../../typescript@4.9.3/node_modules/typescript/bin/tsc" $args
  }
  $ret=$LASTEXITCODE
} else {
  # Support pipeline input
  if ($MyInvocation.ExpectingInput) {
    $input | & "node$exe"  "$basedir/../../../../../typescript@4.9.3/node_modules/typescript/bin/tsc" $args
  } else {
    & "node$exe"  "$basedir/../../../../../typescript@4.9.3/node_modules/typescript/bin/tsc" $args
  }
  $ret=$LASTEXITCODE
}
