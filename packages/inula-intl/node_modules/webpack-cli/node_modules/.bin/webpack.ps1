...
if (Test-Path "$basedir/node$exe") {
  ...
  if ($MyInvocation.ExpectingInput) {
    $input | & "$basedir/node$exe"  "$basedir/../../../../../webpack@5.88.2_webpack-cli@5.1.4/node_modules/webpack/bin/webpack.js" $args
  } else {
    & "$basedir/node$exe"  "$basedir/../../../../../webpack@5.88.2_webpack-cli@5.1.4/node_modules/webpack/bin/webpack.js" $args
  }
  $ret=$LASTEXITCODE
} else {
  # Support pipeline input
  if ($MyInvocation.ExpectingInput) {
    $input | & "node$exe"  "$basedir/../../../../../webpack@5.88.2_webpack-cli@5.1.4/node_modules/webpack/bin/webpack.js" $args
  } else {
    & "node$exe"  "$basedir/../../../../../webpack@5.88.2_webpack-cli@5.1.4/node_modules/webpack/bin/webpack.js" $args
  }
  $ret=$LASTEXITCODE
}
