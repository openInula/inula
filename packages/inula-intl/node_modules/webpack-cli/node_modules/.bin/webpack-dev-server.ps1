...
if (Test-Path "$basedir/node$exe") {
  ...
  if ($MyInvocation.ExpectingInput) {
    $input | & "$basedir/node$exe"  "$basedir/../../../../../webpack-dev-server@4.15.1_w46lltld4evug5kpkz4iei6qt4/node_modules/webpack-dev-server/bin/webpack-dev-server.js" $args
  } else {
    & "$basedir/node$exe"  "$basedir/../../../../../webpack-dev-server@4.15.1_w46lltld4evug5kpkz4iei6qt4/node_modules/webpack-dev-server/bin/webpack-dev-server.js" $args
  }
  $ret=$LASTEXITCODE
} else {
  # Support pipeline input
  if ($MyInvocation.ExpectingInput) {
    $input | & "node$exe"  "$basedir/../../../../../webpack-dev-server@4.15.1_w46lltld4evug5kpkz4iei6qt4/node_modules/webpack-dev-server/bin/webpack-dev-server.js" $args
  } else {
    & "node$exe"  "$basedir/../../../../../webpack-dev-server@4.15.1_w46lltld4evug5kpkz4iei6qt4/node_modules/webpack-dev-server/bin/webpack-dev-server.js" $args
  }
  $ret=$LASTEXITCODE
}
