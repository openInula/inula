...
import NavSelector from './nav-selector';
import { usePathname, useSelectedSegment } from '@/utils/router-utils';
...
const Nav = ({
  ...
  useEffect(() => {
    if (pathname === link) setLinkLastSearchParams(searchParams.toString());
  ...
  return (
    ...
    >
          ...
          className={classNames(`
            ...
            ${
              isActivated
                ...
                : 'text-components-main-nav-nav-button-text'
            }
      ...
      {curNav && navs.length && isActivated && (
        <>
