...
import ConfirmAddVar from '@/components/app/configuration/config-prompt/confirm-add-var'
import type { OpeningStatement } from '@/components/base/features/types'
import { getInputKeys } from '@/components/base/block-input'
