...
`.trim())
  ...
  await writeFile(path.resolve(currentPath, `${fileName}.module.css`), `${componentCSSRender({ assetPath: path.posix.join('~@/components/base/icons/assets', ...pathList.slice(2), entry) })}\n`)
