  ...
  return (
    ...
    >
      ...
      <div className='mt-10 flex justify-end'>
        <Button className='mr-2 shrink-0' onClick={onClose}>取消</Button>
        <Button variant='primary' className='shrink-0' onClick={() => onSave(tempName)} loading={saveLoading}>保存</Button>
      </div>
    </Modal>
  )
}
