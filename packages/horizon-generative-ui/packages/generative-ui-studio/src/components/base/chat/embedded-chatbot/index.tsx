...
import { checkOrSetAccessToken } from '@/components/share/utils'
import AppUnavailable from '@/components/base/app-unavailable'
import useBreakpoints, { MediaType } from '@/hooks/use-breakpoints'
import Loading from '@/components/base/loading'
import LogoHeader from '@/components/base/logo/logo-embedded-chat-header'
import Header from '@/components/base/chat/embedded-chatbot/header'
import ChatWrapper from '@/components/base/chat/embedded-chatbot/chat-wrapper'
