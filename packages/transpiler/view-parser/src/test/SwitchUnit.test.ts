...
describe('SwitchUnit', () => {
  ...
  it('should correctly parse the discriminant of an switch statement', () => {
    ...
    const originalExpression = (statement.body[0] as t.SwitchStatement).discriminant;
  ...
  it('should correctly parse the count of branches', () => {
    const viewUnits = parse('switch(true) { case 1: break; case 2: break; case 3: break; }');
    const switchUnit = viewUnits[0] as SwitchUnit;
  ...
  it('should correctly parse the case of a branch', () => {
    ...
    const viewUnits = parseView(statement);
    const originalExpression = ((statement.body[0] as t.SwitchStatement).cases[0] as t.SwitchCase).test;
    const switchUnit = viewUnits[0] as SwitchUnit;
