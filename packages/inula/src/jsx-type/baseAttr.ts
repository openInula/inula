import {
  ...
  ClassAttributes,
  InulaClipboardEventHandler,
  InulaCompositionEventHandler,
  InulaDragEventHandler,
  InulaFocusEventHandler,
  InulaFormEventHandler,
  InulaBoolean,
  InulaCSSProperties,
  InulaEventHandler,
  InulaNode,
  ...
  InulaPointerEventHandler,
  InulaTouchEventHandler,
  InulaTransitionEventHandler,
  InulaUIEventHandler,
  InulaWheelEventHandler,
} from '../types';
...
export interface InulaSVGProps<T> extends SVGAttributes<T>, ClassAttributes<T> {}
