...
describe('ReactIncremental', () => {
  ...
  it('使用严格模式不应该报错', () => {
    expect(() => {
      ReactNoop.render(<React.StrictMode>
        <div>TEST</div>
      </React.StrictMode>);
    }).not.toThrow()
  });
  ...
  it('使用Profiler不应该报错', () => {
    expect(() => {
      ReactNoop.render(<React.Profiler>
        <div>TEST</div>
      </React.Profiler>);
    }).not.toThrow()
  });
  ...
  it('should render a simple component, in steps if needed', () => {
    ...
    expect(Scheduler).toHaveYielded(['Foo', 'Bar', 'Bar', 'callback']);
  });
  ...
  // Concurrent
  xit('can cancel partially rendered work and restart', () => {
    function Bar(props) {
      Scheduler.unstable_yieldValue('Bar');
      return <div>{props.children}</div>;
    }
  ...
  it('memoizes work even if shouldComponentUpdate returns false', () => {
    ...
    expect(Scheduler).toHaveYielded(['shouldComponentUpdate: false']);
  ...
  it('can forceUpdate', () => {
    ...
    ReactNoop.render(<Foo />);
    expect(Scheduler).toHaveYielded(['Foo', 'Bar', 'Baz']);
    instance.forceUpdate();
    expect(Scheduler).toHaveYielded(['Bar', 'Baz']);
  });
  ...
  it('calls getDerivedStateFromProps even for state-only updates', () => {
    ...
    expect(Scheduler).toHaveYielded(['getDerivedStateFromProps', 'render']);
  ...
  // Concurrent
  xit('does not interrupt for update at same priority', () => {
  ...
  // Concurrent
  xit('does not interrupt for update at lower priority', () => {
    function Parent(props) {
      Scheduler.unstable_yieldValue('Parent: ' + props.step);
      return <Child step={props.step} />;
    }
  ...
  // Concurrent
  xit('does interrupt for update at higher priority', () => {
    function Parent(props) {
      Scheduler.unstable_yieldValue('Parent: ' + props.step);
      return <Child step={props.step} />;
    }
