...
describe('ReactSymbols', () => {
  ...
  it('Symbol values should be unique', () => {
    expectToBeUnique(Object.entries(require('inula/src/external/JSXElementType')));
  });
  ...
  it('numeric values should be unique', () => {
    ...
    try {
      const entries = Object.entries(require('inula/src/external/JSXElementType')).filter(
