...
describe('ReactDOMSelect', () => {
  ...
  xit('should warn if value is null', () => {
    expect(() =>
      ...
      '`value` prop on `select` should not be null, please use an empty string.',
    );
  ...
  xit('should warn if value is null and multiple is true', () => {
    expect(() =>
      ReactTestUtils.renderIntoDocument(
      ...
      '`value` prop on `select` should not be null, please use an empty array.',
    );
  ...
  it('should be able to safely remove select onChange', () => {
    ...
    const stub = (
      <select value="giraffe" onChange={changeView} ref={ref}>
        <option value="monkey">A monkey!</option>
        <option value="giraffe">A giraffe!</option>
        <option value="gorilla">A gorilla!</option>
      </select>
