...
import * as ReactTestUtils from 'react-test-renderer/test-utils';
...
describe('ReactTestUtils', () => {
  xit('Simulate should have locally attached media events', () => {
  ...
  // describe('Simulate', () => {
  //   xit('should change the value of an input field', () => {
  //     const obj = {
  //       handler: function(e) {
  //       },
  //     };
  ...
  //   });
  //
  //   xit('should change the value of an input field in a component', () => {
  //     class SomeComponent extends React.Component {
  //       render() {
  //         return (
  //           <div>
  ...
  //   });
  //
  //   xit('should set the type of the event', () => {
  //     let event;
  ...
  //     expect(event.nativeEventType).toBe('keydown');
  //   });
  //
  //   xit('should work with renderIntoDocument', () => {
