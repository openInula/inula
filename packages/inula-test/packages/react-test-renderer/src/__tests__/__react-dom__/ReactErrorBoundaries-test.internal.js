...
describe('ReactErrorBoundaries', () => {
  ...
  it('resets callback refs if mounting aborts', () => {
    ...
    expect(Scheduler).toHaveYielded([
      ...
      'BrokenRender componentWillMount',
      'BrokenRender render [!]',
      'Child ref is set to [object HTMLDivElement]',
      'BrokenRender componentDidMount',
      'ErrorBoundary componentDidMount',
      // Handle the error
      'ErrorBoundary static getDerivedStateFromError',
  ...
  it('keeps refs up-to-date during updates', () => {
    ...
    expect(Scheduler).toHaveYielded([
      ...
      'BrokenRender componentWillMount',
      'BrokenRender render [!]',
      'Child2 ref is set to [object HTMLDivElement]',
      'BrokenRender componentDidMount',
      'ErrorBoundary componentDidUpdate',
      // Handle the error
      'ErrorBoundary static getDerivedStateFromError',
  ...
  it('renders empty output if error boundary does not handle the error', () => {
    ...
    expect(container.innerHTML).toBe('<div>Sibling</div>');
    expect(Scheduler).toHaveYielded([
  ...
  xit('should catch errors from errors in the throw phase from boundaries', () => {
    const container = document.createElement('div');
