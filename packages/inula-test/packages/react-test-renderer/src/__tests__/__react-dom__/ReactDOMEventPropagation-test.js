...
describe('ReactDOMEventListener', () => {
  ...
  beforeEach(() => {
    ...
    jest.isolateModules(() => {
      OuterReactDOM = require('horizon');
    });
    jest.isolateModules(() => {
      InnerReactDOM = require('horizon');
    });
  ...
  describe('non-delegated bubble events', ()=>{

    it('onLostPointerCapture', () => {
      testNonDelegatedBubblingEvent({
        type: 'div',
  ...
  function testNonDelegatedBubblingEvent(config) {
    testNativeBubblingEventWithTargetListener(config);
    testNativeBubblingEventWithoutTargetListener(config);
    testReactStopPropagationInOuterCapturePhase(config);
    testReactStopPropagationInInnerCapturePhase(config);
