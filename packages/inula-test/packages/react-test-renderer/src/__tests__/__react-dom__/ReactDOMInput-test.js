...
describe('ReactDOMInput', () => {
  ...
  // @gate enableControlledValue && enableLazyDelegate
  ...
  xit('should update `defaultValue` for uncontrolled input', () => {
  ...
  xit('should update `defaultValue` for uncontrolled date/time input', () => {
    const node = ReactDOM.render(
  ...
  xit('should properly control 0.0 for a number input', () => {
  ...
  xit('should properly transition from an empty value to 0', function() {
    ReactDOM.render(
  ...
  xit('should properly transition from 0 to an empty value', function() {
    ReactDOM.render(
      <input type="text" value={0} onChange={emptyFunction} />,
      container,
    );
  ...
  xit('should properly transition a text input from 0 to an empty 0.0', function() {
    ReactDOM.render(
      <input type="text" value={0} onChange={emptyFunction} />,
      container,
    );
  ...
  xit('should properly transition a number input from "" to 0', function() {
    ReactDOM.render(
  ...
  xit('should restore uncontrolled inputs to last defaultValue upon reset', () => {
  ...
  xit('should not set an undefined value on a reset input', () => {
  ...
  xit('should not set a null value on a submit input', () => {
  ...
  xit('should not set a null value on a reset input', () => {
  ...
  // @gate enableControlledValue && enableRadioControlled
  ...
  xit('should warn if value is null', () => {
    expect(() =>
      ...
      '`value` prop on `input` should not be null, please use an empty string.',
    );
    ReactDOM.unmountComponentAtNode(container);
  ...
  it('should warn if controlled input switches to uncontrolled (value is undefined)', () => {
    ...
    ReactDOM.render(stub, container);
    expect(() => ReactDOM.render(<input type="text" />, container)).not.toThrow();
  });

  xit('should warn if controlled input switches to uncontrolled (value is null)', () => {
    const stub = (
      <input type="text" value="controlled" onChange={emptyFunction} />
    );
    ReactDOM.render(stub, container);
  ...
  xit('should warn if uncontrolled input (value is null) switches to controlled', () => {
  ...
  it('should warn if controlled radio switches to uncontrolled (checked is undefined)', () => {
    ...
    ReactDOM.render(stub, container);
    expect(() => ReactDOM.render(<input type="radio" />, container)).not.toThrow();
  });
  ...
  describe('assigning the value attribute on controlled inputs', function() {
    ...
    xit('sets the value attribute on number inputs on blur', () => {
      const Input = getTestInput();
      const stub = ReactDOM.render(
        <Input type="number" value="1" />,
        container,
  ...
  describe('setting a controlled input to undefined', () => {
    ...
    it('reverts the value attribute to the initial value', () => {
      expect(renderInputWithStringThenWithUndefined).not.toThrow();
      if (disableInputAttributeSyncing) {
  ...
  describe('setting a controlled input to null', () => {
    ...
    xit('reverts the value attribute to the initial value', () => {
    ...
    xit('preserves the value property', () => {
      expect(renderInputWithStringThenWithNull).toErrorDev([
        '`value` prop on `input` should not be null, please use an empty string.',
      ]);
      expect(input.value).toBe('latest');
