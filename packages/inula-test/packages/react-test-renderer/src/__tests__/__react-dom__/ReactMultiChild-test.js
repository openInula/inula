...
describe('ReactMultiChild', () => {
  ...
  describe('reconciliation', () => {
    ...
    xit('should warn for duplicated array keys with component stack info', () => {
      const container = document.createElement('div');
    ...
    xit('should warn for duplicated iterable keys with component stack info', () => {
      const container = document.createElement('div');
  ...
  xit('should warn for using maps as children with owner info', () => {
    class Parent extends React.Component {
      render() {
        return (
          <div>
    ...
    expect(() => ReactDOM.render(<Parent />, container)).toErrorDev(
      'map is not supported, try using an array',
    );
  });

  xit('should warn for using generators as children', () => {
    function* Foo() {
    ...
    }).toErrorDev('Bad iteration, try using array');
