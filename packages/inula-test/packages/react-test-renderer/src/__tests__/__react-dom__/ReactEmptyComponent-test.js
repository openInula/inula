...
describe('ReactEmptyComponent', () => {
  ...
  xit('should still throw when rendering to undefined', () => {
    ...
    }).toThrowError('Component(...): The render function cannot return null');
  });
  ...
  xit('should warn about React.forwardRef that returns undefined', () => {
    const Empty = () => {};
    ...
    expect(() => {
      ...
      'ForwardRef(Empty)(...): The render function cannot return null.',
    );
  });

  xit('should warn about React.memo that returns undefined', () => {
    const Empty = () => {};
    const EmptyMemo = React.memo(Empty);

    expect(() => {
      ReactTestUtils.renderIntoDocument(<EmptyMemo />);
    }).toThrowError('Empty(...): The render function cannot return null.');
  });
});
