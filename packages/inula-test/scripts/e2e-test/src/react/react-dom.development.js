 ...
 (function (global, factory) {
  ...
  function assertValidProps(tag, props) {
    ...
    if (props.dangerouslySetInnerHTML != null) {
      ...
      if (!(typeof props.dangerouslySetInnerHTML === 'object' && HTML in props.dangerouslySetInnerHTML)) {
        {
          throw Error( "`dangerouslySetInnerHTML` format error. Please visit https://reactjs.org/link/dangerously-set-inner-html for more information." );
        }
      }
    }
  ...
  function createSyntheticEvent(Interface) {
    ...
    _assign(SyntheticBaseEvent.prototype, {
      ...
      /**
       * We release all dispatched `HroizonEventFactory`s after each event loop, adding
  ...
  var scheduleRoot = function (root, element) {
    {
      ...
      flushPassiveEffects();
      flushSync(function () {
        startUpdate(element, root, null, null);
      });
    }
  };
