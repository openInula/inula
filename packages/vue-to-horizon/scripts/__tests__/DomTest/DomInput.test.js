...
describe('Dom Input', () => {
  ...
  describe('type checkbox', () => {
    it('没有设置checked属性时，控制台不会报错', () => {
      expect(() => Horizon.render(<input type="checkbox" value={false} />, container)).not.toThrow();
    });

    it('checked属性为undefined或null时且没有onChange属性或没有readOnly={true}，控制台不会报错', () => {
      expect(() => Horizon.render(<input type="checkbox" checked={undefined} />, container)).not.toThrow();
      expect(() => Horizon.render(<input type="checkbox" checked={null} />, container)).not.toThrow();
    });
    ...
    it('复选框不设置value属性值时会设置value为"on"', () => {
      Horizon.render(<input type="checkbox" defaultChecked={true} />, container);
    ...
    it('测试defaultChecked与更改defaultChecked', () => {
      Horizon.render(<input type="checkbox" defaultChecked={0} />, container);
      expect(container.querySelector('input').value).toBe('on');
      expect(container.querySelector('input').checked).toBe(false);

      Horizon.render(<input type="checkbox" defaultChecked={1} />, container);
      expect(container.querySelector('input').value).toBe('on');
  ...
  describe('type text', () => {
    it('value属性为undefined或null时且没有onChange属性或没有readOnly={true}，控制台不会报错', () => {
      expect(() => Horizon.render(<input type="text" value={undefined} />, container)).not.toThrow();
      expect(() => Horizon.render(<input type="text" value={null} />, container)).not.toThrow();
      expect(() => Horizon.render(<input type="text" />, container)).not.toThrow();
    });
  ...
  describe('type number', () => {
    it('value值会把number类型转为字符串，且.xx转为0.xx', () => {
      Horizon.render(<input type="number" value={0.12} />, container);
      expect(container.querySelector('input').hasAttribute('value')).toBe(true);
    ...
    it('node.value精度', () => {
      let setNum;
      const App = () => {
        const [num, _setNum] = Horizon.useState(0.0);
        setNum = _setNum;
        return <input type="number" value={num} readOnly={true} />;
      };
      Horizon.render(<App />, container);
  ...
  describe('type reset', () => {
    it('type reset的value值', () => {
      Horizon.render(<input type="reset" value={0.12} />, container);
      expect(container.querySelector('input').hasAttribute('value')).toBe(true);
      expect(container.querySelector('input').getAttribute('value')).toBe('0.12');
