import Inula, { createContext, useContext, Children, createElement, useState, useRef, useLayoutEffect, useMemo, isValidElement, cloneElement, reduxAdapter } from '@cloudsop/horizon';
import { connect, ReactReduxContext } from 'react-redux';
import { jsx, Fragment } from '@cloudsop/horizon/jsx-runtime';
...
function withRouter(Component) {
  return function (props) {
    ...
    var context = useContext(RouterContext);
    return jsx(Component, _extends({}, rest, context, {
...
function ConnectedRouterWithoutMemo(props) {
  ...
  // 监听store变化
  var unsubscribe = useRef(store.subscribe(function () {
  ...
  // 监听history更新
  var unListen = useRef(history.listen(handleLocationChange));
  useLayoutEffect(function () {
    return function () {
...
function getConnectedRouter(type) {
  ...
  var ConnectedRouter = Inula.memo(ConnectedRouterWithoutMemo);
  var ConnectedRouterWithContext = function (props) {
    ...
    return jsx(Context.Consumer, {
      children: function (_ref) {
        ...
        return jsx(ConnectedRouter, _extends({
          store: store,
          storeType: type
        }, props));
      }
