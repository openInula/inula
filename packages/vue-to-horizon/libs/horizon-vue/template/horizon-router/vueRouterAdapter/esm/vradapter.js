...
var RouteContext = createContext(START_LOCATION);
var CurrentRouteRecord = createContext(null);
...
function RouterProvider(props) {
  ...
  var isMount = useRef(false);
  var detachObserver = useRef(null);
  var urlLocation = parseURL(history.location);
  var _useState = useState(currentRoute),
...
function useRegisterGuards(name, guard) {
  var match = useContext(CurrentRouteRecord);
  useLayoutEffect(function () {
