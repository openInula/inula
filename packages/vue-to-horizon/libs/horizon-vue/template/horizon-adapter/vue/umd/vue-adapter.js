(function (global, factory) {
    ...
    var app = context.app = {
      ...
      mount: function mount(rootContainer) {
        if (!isMounted) {
          ...
          Horizon__default["default"].render(jsxRuntime.jsx(AppWrapper, {
  ...
  function GlobalComponent(_ref) {
    ...
    return jsxRuntime.jsx(Comp, _objectSpread$7({}, otherProps));
  }
  ...
  function defineAsyncComponent(loader) {
    ...
    return function (props) {
      return jsxRuntime.jsx(Horizon.Suspense, {
        fallback: null,
        children: jsxRuntime.jsx(LazyComponent, _objectSpread$7({}, props))
      });
    };
  }
  ...
  function createVNode(component, props) {
    return Horizon__default["default"].createElement(component, props, props.children);
  }
  function render(vnode, target) {
    Horizon__default["default"].render(vnode, target);
  }
  function useWindowSize() {
    ...
    var width = Horizon.vueReactive.useReference(initialWidth);
    var height = Horizon.vueReactive.useReference(initialHeight);
    function update() {
      if (window) {
        if (includeScrollbar) {
    ...
    update();
    Horizon__default["default"].useEffect(function () {
  ...
  function DirectiveComponent(props) {
    ...
    return Horizon.createElement(componentName, _objectSpread$6({}, rest), children);
  }
  ...
  function DynamicComponent(_ref) {
    ...
    return jsxRuntime.jsx(Component, _objectSpread$5({}, componentProps));
  }
  ...
  function useScoped() {
    ...
    var preNodeStyle = Horizon.useRef(null);
    ...
    var mergeStyle = Horizon.useCallback(function () {
      var el = instance.$el;
  ...
  var SemiControlledInput = function SemiControlledInput(_ref) {
    ...
    // 渲染 input 元素
    return jsxRuntime.jsx("input", _objectSpread$2({
  ...
  var Keeper = function Keeper(_ref) {
    ...
    var nodeKeeperLifeCycleValue = Horizon.useRef(_defineProperty(_defineProperty({}, KEEP_ALIVE_LIFECYCLE.ACTIVATE, []), KEEP_ALIVE_LIFECYCLE.UNACTIVATE, []));
    Horizon.useEffect(function () {
      return function () {
  ...
  function Teleport(_ref) {
    ...
    if (disabled) {
      return jsxRuntime.jsx(Horizon.Fragment, {
        children: children
      });
    }

    // 如果目标容器存在，则使用 createPortal 进行传送
    return container ? Horizon.createPortal(children, container) : null;
  }

  var _excluded$1 = ["value", "onChange"];
  function ownKeys$1(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
  function _objectSpread$1(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys$1(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys$1(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
  var ReactiveAdapterInput = Horizon.forwardRef(function (_ref, ref) {
    var value = _ref.value,
      onChange = _ref.onChange,
      props = _objectWithoutProperties(_ref, _excluded$1);
    var _useState = Horizon.useState(props.value),
      _useState2 = _slicedToArray(_useState, 2),
      val = _useState2[0],
      setVal = _useState2[1];
    Horizon.useEffect(function () {
    ...
    return jsxRuntime.jsx("input", _objectSpread$1(_objectSpread$1({
      value: val,
  ...
  var ReactiveAdapterTextarea = Horizon.forwardRef(function (_ref, ref) {
    var value = _ref.value,
      onChange = _ref.onChange,
    ...
    return jsxRuntime.jsx("textarea", _objectSpread(_objectSpread({
      value: val,
      onChange: changeHandler
    }, props), {}, {
      ref: ref
  ...
  exports.ReactiveAdapterInput = ReactiveAdapterInput;
  exports.ReactiveAdapterTextarea = ReactiveAdapterTextarea;
