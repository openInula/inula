...
declare function GlobalComponent({ componentName, ...otherProps }: {
    [x: string]: any;
    componentName: any;
}): any;
...
declare function defineEmits<T extends EmitsOptions>(emits: T, props: AnyProps): <K extends keyof T>(eventName: K, ...args: Parameters<any>) => void;
