...
function DirectiveComponent(props) {
  ...
  var prevDirectiveValues = useMemo(function () {
    return {};
  }, []);
  var applyDirectives = useCallback(function (hook, directives) {
 ...
 * See the Mulan PSL v2 for more details.
 */
var shallowReactive = vueReactive.shallowReactive;
/**
 * 自定义 Hook，用于处理响应式属性
...
function setFullProps(rawProps, props, options) {
  ...
  for (var _key2 in options) {
    if (
      Object.prototype.hasOwnProperty.call(options, _key2) &&
      (!Object.prototype.hasOwnProperty.call(props, _key2) || props[_key2] === undefined)
    ) {
...
var KeepAlivePro = function (_ref) {
  ...
  var componentData;
  var componentCache = useRef(new Map());
  var searchComponent = Array.isArray(children) ? children[0] : children;
  var componentName =
    searchComponent.props.ref ||
    ((_searchComponent$prop = searchComponent.props.is) === null || _searchComponent$prop === void 0
      ? void 0
      : _searchComponent$prop.name);
  var onActivatedListeners = useRef(new Map());
  var onDeactivatedListeners = useRef(new Map());
  ...
  return jsxs(Fragment, {
    children: [
      Array.from(componentCache.current.entries()).map(function (_ref3) {
        var name = _ref3[0],
          data = _ref3[1];
        provide('keep-alive-key', name);
        if (componentName === name) {
...
var Keeper = function (_ref) {
  ...
  var nodeKeeperLifeCycleValue = useRef(
    ((_useRef = {}),
    _defineProperty(_useRef, KEEP_ALIVE_LIFECYCLE.ACTIVATE, []),
    _defineProperty(_useRef, KEEP_ALIVE_LIFECYCLE.UNACTIVATE, []),
    _useRef)
  );
  useEffect(function () {
    return function () {
  ...
  useEffect(
    function () {
      if (active) {
        ...
        childrenNode.current = Array.from(
          ((_wrapper$current = wrapper.current) === null || _wrapper$current === void 0
            ? void 0
            : _wrapper$current.children) || []
        );
        childrenNode.current.forEach(function (child) {
          var _wrapper$current2, _wrapper$current2$par;
          (_wrapper$current2 = wrapper.current) === null || _wrapper$current2 === void 0
            ? void 0
            : (_wrapper$current2$par = _wrapper$current2.parentElement) === null || _wrapper$current2$par === void 0
              ? void 0
              : _wrapper$current2$par.insertBefore(child, wrapper.current);
        });
        ...
        childrenNode.current.forEach(function (child) {
          ...
          (_wrapper$current3 = wrapper.current) === null || _wrapper$current3 === void 0
            ? void 0
            : _wrapper$current3.appendChild(child);
        });
        nodeKeeperLifeCycleValue.current[KEEP_ALIVE_LIFECYCLE.UNACTIVATE].forEach(function (callback) {
          callback();
        });
  ...
  return jsx(NodeKeeperLifeCycleContext.Provider, {
...
function getComponentKey(children) {
  ...
  return children === null || children === void 0
    ? void 0
    : (_children$type = children.type) === null || _children$type === void 0
      ? void 0
      : _children$type.name;
}
function KeepAlive(_ref) {
  ...
  return jsxs(Fragment, {
    children: [
      Array.from(childrenMap.current.values()).map(function (_ref2) {
        var children = _ref2.children,
          key = _ref2.key;
        return jsx(
          Keeper,
