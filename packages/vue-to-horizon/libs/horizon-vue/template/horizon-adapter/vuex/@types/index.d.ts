...
declare function prepareTypeParams(
  type:
    | string
    | (Record<string, unknown> & {
        type: string;
...
declare const useMapState: (
  moduleName: any,
  states: any
) => {
  [key: string]: ComputedImpl<any>;
};
declare const useMapGetters: (
  moduleName: any,
  getters: any
) => {
  [key: string]: ComputedImpl<any>;
};
declare const useMapMutations: (
  moduleName: any,
  mutations: any
) => {
  [key: string]: () => any;
};
declare const useMapActions: (
  moduleName: any,
  actions: any
) => {
  [key: string]: () => any;
