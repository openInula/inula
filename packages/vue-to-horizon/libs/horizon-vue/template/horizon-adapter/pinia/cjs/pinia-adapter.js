...
var ref = horizon.vueReactive.ref,
  isRef = horizon.vueReactive.isRef,
  toRef = horizon.vueReactive.toRef,
  isReactive = horizon.vueReactive.isReactive,
...
function storeToRefs(store) {
  var stateRefs = Object.fromEntries(Object.entries(store.$s || {}).map(function (_ref2) {
    var key = _ref2[0],
      value = _ref2[1];
    return [key, ref(value)];
  }));
  var getterRefs = Object.fromEntries(Object.entries(store.$config.computed || {}).map(function (_ref3) {
    var key = _ref3[0],
      value = _ref3[1];
